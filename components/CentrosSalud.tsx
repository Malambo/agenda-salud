  ...
  // Función para desplazar a elementos activos
    ...
    return (
        <div className="w-full mx-auto border-t border-emerald-500 flex flex-col items-center">
            ...
            <div
            className="
            w-full p-8 flex gap-36 items-start justify-between
            border border-t-0 border-emerald-300
            bg-emerald-200/50 bg-gradient-to-b from-emerald-200/20 via-emerald-100 to-emerald-100 shadow">
